...
python3 ores_archaeologist.py score_commit_revisions --commit=860c70b73de36d63584db019cccf841f943622e7 --cutoff_revisions='ores_bias_data/test_revisions_sample.csv'  --wrap=True
